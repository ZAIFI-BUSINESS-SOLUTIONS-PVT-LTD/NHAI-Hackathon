...
// Interleaved: [cx0, cy0, cx1, cy1, ...]
// Stride 8  → 16×16 feature map, 2 anchors per cell = 512 anchors
// Stride 16 → 8×8  feature map, 6 anchors per cell = 384 anchors
// Total: 896
...
export function runFaceDetection(
  ...
  // outputs[1]: classificators [896 × 1] — raw logits
